...
@Component
export default class RoleAssignmentDiffComponent extends DiffApprComponent<Role, any> {
  renderFields = [
    ...
    {resourceKey: 'role_assigned_users', name: 'users', 'label': 'userId'},
  ];

  created() {
    this.onCreated(
      applicationContext.roleAssignmentService,
      storage.resource(),
      storage.getLocale,
      showToast,
      alertError,
